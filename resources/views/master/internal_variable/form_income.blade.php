        ...
        <div class="modal-content">
            <form method="post" onsubmit="return false;"
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">{{($data->iv_income_work_exp_uuid)?'Edit':'Add'}} Income &
                        Work Exp</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Income</label>
                        <input type="number" class="form-control" name="income" placeholder="10"
                               value="{{$data->income}}" min="0" required>
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Work Exp (months)</label>
                        <input type="number" class="form-control" name="work_exp" placeholder="10"
                               value="{{$data->work_exp}}" min="0" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    @csrf
                    <input type="hidden" name="iv_income_work_exp_uuid" value="{{$data->iv_income_work_exp_uuid}}">
