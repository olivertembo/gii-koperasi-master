    ...
    <script>
        ...
        table = $('#myTable').DataTable({
            ...
            columnDefs: [
                ...
                {"targets": 1, "name": "fine_type_symbol", "title": "Day"},
                {"targets": 2, "name": "is_percentage", "title": "Use Persentage"},
                {"targets": 3, "name": "fine_percentage", "title": "Fine Percentage"},
                {"targets": 4, "name": "fine_amount", "title": "Fine Amount"},
