...
class AdministratorController extends Controller
{
    ...
    public function dataTable(Request $request)
    {
        ...
        $select = "users.*, user_statuses.user_status_name, roles.role_name";
        ...
        $where = " users.type=1 and users.deleted_at is null and 
        ...
        echo json_encode([
            ...
            'recordsTotal' => User::where('type', 1)->where('deleted_at', null)->count(),
