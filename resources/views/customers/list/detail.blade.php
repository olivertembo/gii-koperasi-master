                ...
                <div class="card-body">
                    <center class="m-t-30">
                        ...
                        <div class="row text-center justify-content-md-center">
                            ...
                            <div class="col-6"><font class="font-medium">{{$data->join_date}}</font></div>
                        </div>
                    </center>
                </div>
                <div>
                    ...
                    <div class="form-group row pt-3">
                        <div class="col-sm-12">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" value="true" disabled
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div id="messages"></div>
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-2">Customer Number</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" value="{{$data->customer_number}}"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    {{--<div class="col-md-10">--}}
                                    {{--<select name="upgrade_status_id" id="" class="form-control" disabled>--}}
